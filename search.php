            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    <div class="post-content">
                        <div class="row">
                            <div class="col-md-4">
                                <a class="post-img" href='single.php?id=<?php echo $data["post_id"]?>'><img src="admin/uploads/<?php echo $data['post_img']?>" alt=""/></a>
                            </div>
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    ...
                                    <div class="post-information">
                                        <span>
                                            ...
                                            <a href='category.php?cat_id=<?php echo $cat_id?>'><?php echo $data['category_name']?></a>
                                        </span>
                                        <span>
